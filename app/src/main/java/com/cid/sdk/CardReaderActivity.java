...
public class CardReaderActivity
	...
	private final String TAG = CardReaderActivity.class.getSimpleName();
	// ------------------------------------ READ APDU ------------------------------------
	...
	private Biometrics.OnCardStatusListener onCardStatusListener = (String ATR,
		...
		if (currentState == 1) {
			Log.d(TAG, "Card was removed, no card present.");
	...
	private void
	openCardReader() {
		final String localTag = TAG + ":openCardReader";
		Log.d(TAG, "openCardReader()");
