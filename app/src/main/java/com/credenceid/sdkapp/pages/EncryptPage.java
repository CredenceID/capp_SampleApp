...
public class EncryptPage extends LinearLayout implements PageView {
    ...
    private void initialize() {
        ...
        buttonGenerate = (Button) findViewById(R.id.generate_btn);
        ...
        buttonEncrypt = (Button) findViewById(R.id.encrypt_btn);
        ...
        buttonDecrypt = (Button) findViewById(R.id.decrypt_btn);
        ...
        mPassphraseEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable arg0) {
                ...
                buttonGenerate.setEnabled(!content.isEmpty());
            }
        ...
        mKeyEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable arg0) {
                ...
                buttonEncrypt.setEnabled(!content.isEmpty());
            }
